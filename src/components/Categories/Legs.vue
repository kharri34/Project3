<template>
  <div class="legs">
    <section class="page-title-wrapper">
      <div class="page-title-top">Legs</div>
      <div class="page-title-bottom" aria-hidden="true">Legs</div>
    </section>
    ...
    <section class="category">
      ...
      <div class="workout">
        <div class="workout-image">
          <img src="@/assets/Exercise Images/Leg Images/bws.gif" alt="Beginner Workout" />
        </div>
    ...
    <section class="category">
      ...
      <div class="workout">
        <div class="workout-image">
          <img src="@/assets/Exercise Images/Leg Images/wl.gif" alt="Intermediate Workout" />
        </div>
        <div class="workout-details">
    ...
    <section class="category">
      ...
      <div class="workout">
        <div class="workout-image">
          <img src="@/assets/Exercise Images/Leg Images/js.gif" alt="Advanced Workout" />
        </div>
        <div class="workout-details">
